...
function se(e = !1, t = !1) {
  return function (n, o, r) {
    ...
    return (x(o) && Y.has(o)) || '__proto__' === o
      ? l
      : (e || Z(n, 0, o), t ? l : ze(l) ? (s ? l : l.value) : C(l) ? (e ? Ne(l) : je(l)) : l)
  }
}
...
function le(e = !1) {
  return function (t, n, o, r) {
    ...
    return t === De(r) && (l ? $(o, s) && X(t, 'set', n, o) : X(t, 'add', n, o)), i
  }
}
function ie(e, t) {
...
const Fe = { get: Oe(!1, !1) },
  ...
  $e = (e) => !e.__v_skip && Me(((e) => k(e).slice(8, -1))(e)) && !Object.isFrozen(e)
function je(e) {
...
function He(e, t = !1) {
  ...
  const o = {
    ...
    set value(r) {
      $(De(r), e) && ((e = r), (n = t ? r : qe(r)), X(o, 'set', 'value', void 0))
    }
  }
  return o
}
...
function it(e) {
  let t
  for (tt = !1, et = !0, Ze.sort((e, t) => lt(e) - lt(t)); void 0 !== (t = Ze.shift()); ) null !== t && Ge(t, null, 14)
            ...
            if (!(o || l > 0) || 16 & l) {
              ...
              for (const e in i)
                (t && (y(t, e) || ((o = L(e)) !== e && y(t, o)))) ||
                  (c ? n && void 0 !== n[o] && (r[e] = Zt(c, t || a, e, void 0)) : delete r[e])
  ...
  return (function (e, t, { immediate: n, deep: o, flush: r, onTrack: s, onTrigger: l } = a) {
    ...
    const h = t
      ? () => {
          ...
          const e = g()
          ;(o || $(e, d)) && (u && u(), Je(t, i, 3, [e, d === Un ? void 0 : d, p]), (d = e))
        }
      : void 0
    let m
    m =
...
function io(e, t) {
  const n = e.type
  e.render || ((e.render = n.render || f), e.render._rc && (e.withProxy = new Proxy(e.ctx, Yn))),
    (no = e),
    zn(e, n),
    (no = null)
}
      ...
      switch (t) {
        ...
        default:
          h(t)
            ...
            : 'spellcheck' !== t &&
              'draggable' !== t &&
              (s ? 'innerHTML' === t || (t in e && $o.test(t) && _(r)) : t in e && (!$o.test(t) || !w(r)))
...
function xr(e) {
  let t
  if ('selector' in e) {
    const n = _r.test(e.selector) ? document.getElementById(e.selector.slice(1)) : document.querySelector(e.selector)
    if (!n) return
    t = (function (e, t) {
  ...
  return (
      ...
      ),
    {
      ...
      push: function (e, o) {
        ...
        r(l.current, l, !0), r(s, { ...Ar(n.value, s, null), position: l.position + 1, ...o }, !1), (n.value = s)
      },
    ...
    ...(function (e, t) {
      ...
      for (const t of e) {
        ...
        for (let o = 0; o < t.length; o++) {
          ...
          if (0 === l.type) o || (r += '/'), (r += l.value.replace(Yr, '\\$&')), (i += 40)
          else if (1 === l.type) {
...
function ls(e, t) {
  ...
  function r(e, n, o) {
    ...
    for (const e of a) {
      ...
      if (((u = rs(e, n, c)), o ? o.alias.push(u) : ((f = f || u), f !== u && f.alias.push(u)), 'children' in i)) {
        let e = i.children
    ...
    e.forEach((e) => r(e)),
    {
      ...
      resolve: function (e, t) {
        ...
        if ('name' in e && e.name) {
          ...
          ;(l = r.record.name), (i = { ...t.params, ...e.params }), (s = r.stringify(i))
        }
        const c = []
        let a = r
...
function ds(e) {
  const t = qn(sr),
    ...
    r = ao(() => {
      ...
      if (l > -1) return l
      let i = ms(e[t - 2])
      return t > 1 && ms(r) === i && s[s.length - 1].path !== i ? s.findIndex(pr.bind(null, e[t - 2])) : l
    }),
    s = ao(
      () =>
        r.value > -1 &&
    ...
    l = ao(() => r.value > -1 && r.value === n.matched.length - 1 && dr(n.params, o.value.params))
  return {
    route: o,
...
const hs = uo({
  ...
  setup(e, { slots: t, attrs: n }) {
    const o = je(ds(e)),
      { options: r } = qn(sr),
      s = ao(() => ({
        [vs(e.activeClass, r.linkActiveClass, 'router-link-active')]: o.isActive,
        [vs(e.exactActiveClass, r.linkExactActiveClass, 'router-link-exact-active')]: o.isExactActive
      }))
    return () => {
  ...
  setup(e, { attrs: t, slots: n }) {
    ...
    const l = ao(() => r.value.matched[s]),
      ...
      c = ao(() => {
        ...
        return e ? (!0 === e ? r.value.params : 'object' == typeof e ? e : e(r.value)) : {}
      })
    Dn(or, l)
    const a = We()
    function u() {
...
const xs = () => ({ user: ws }),
  ...
  Ss = (function (e) {
    ...
    function g(e, t) {
      ...
      return (
        ...
        (f ? Promise.resolve(f) : y(c, o))
          .catch((e) => (u !== c ? Zr(3, { from: o, to: c }) : 2 === e.type || 1 === e.type ? e : S(e)))
          .then((e) => {
            if (e) {
              if (1 === e.type) return g({ ...m(e.to), state: r, force: s, replace: l }, t || c)
            } else e = _(c, o, !0, l, r)
            return b(c, o, e), e
          })
      )
    ...
    function y(e, t) {
      let n
      n = ps(t.matched.filter((t) => e.matched.indexOf(t) < 0).reverse(), 'beforeRouteLeave', e, t)
      const [o, r] = bs(e, t)
      ...
      return ys(n)
        ...
        .then(() => {
          ...
          for (const o of r) for (const r of o.updateGuards) n.push(fs(r, e, t))
          return ys(n)
        })
        .then(() => {
          n = []
          for (const o of e.matched)
            if (o.beforeEnter && t.matched.indexOf(o) < 0)
              if (Array.isArray(o.beforeEnter)) for (const r of o.beforeEnter) n.push(fs(r, e, t))
    ...
    function _(e, t, n, o, r) {
      ...
      const i = t === Jr,
        c = ir ? history.state : {}
      n && (o || i ? s.replace(e, { scroll: i && c && c.scroll, ...r }) : s.push(e, r)),
        (a.value = e),
        k(e, t, n, i),
        E()
    }
    ...
    function k(e, t, n, o) {
      ...
      let s =
        (!n && ((l = Cr(e.fullPath, 0)), Sr.get(l))) || ((o || !n) && history.state && history.state.scroll) || null
      var l
      return nt()
        .then(() => r(e, t, s))
        .then((e) => e && xr(e))
...
Ss.beforeEach((e, t, n) => {
  var o
  const { user: r } = xs()
  ;(null == (o = r.value) ? void 0 : o.jwt) || Cs.includes(e.path) ? n() : n('/login')
})
        ...
        po(
          ...
          (t, n) => (
            ...
            Mt(
              ...
              [
                It('i', { class: 'icon-close-small', onClick: (t) => e.dismiss(n) }, null, 8, ['onClick']),

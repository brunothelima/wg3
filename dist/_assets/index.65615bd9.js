    ...
    return (
      ...
      e(
        ...
        [
          a(
            r,
            { size: s.size, skin: s.skin },
            { default: _(() => [n(i(s.t("button")), 1)]), _: 1 },
            8,
            ["size", "skin"]
          ),
          a(
...
const q = H(function (n, s) {
  const l = t("GlassyButtons"),
    r = t("CleanButtons");
  return (
    o(), e("section", P, [a("h1", null, i(n.t("title")), 1), $, D, a(l), a(r)])
  );
});
var G = (t) => {
  t.i18n = {
...
const Z = X(function (n, s) {
  ...
  return (
    o(),
    e("div", Y, [
      a("h6", null, i(n.t("title")), 1),
      a(l, { class: "primary", range: 7, cssVar: "--color-a" }),
    ])
  );
});
var tt = (t) => {
...
const nt = et(function (n, s) {
  ...
  return (
    ...
    e("div", at, [
      a("h6", null, i(n.t("title")), 1),
      a(l, { class: "secondary", range: 7, cssVar: "--color-b" }),
    ])
  );
});
var it = (t) => {
...
const ct = lt(function (n, s) {
  ...
  return (
    ...
    e("div", rt, [
      a("h6", null, i(n.t("title")), 1),
      a(l, { class: "grayish", range: 11, cssVar: "--color-x" }),
    ])
  );
});
var dt = (t) => {
        ...
        e(
          ...
          d(
            ...
            (t) => (
              ...
              e(
                "li",
                { key: "color-" + t, class: "color-" + t },
                [a("code", null, i("--color-" + t), 1)],
                2
              )
            )
          ),
  ...
  yt = a(
    ...
    [
      a(
        "code",
        null,
        "linear-gradient(to right, var(--color-a-3), var(--color-b-3));"
      ),
    ],
    -1
  );
...
const Nt = { class: "paragraph" },
  jt = a(
    ...
    [
      ...
      n(
        " corrupti id nulla? lorem ipsum dolor sit amet consectetur adipisicing elit. "
      ),
    ],
    -1
  );
...
const Wt = { class: "labels" },
  Jt = a(
    ...
    [
      a("li", { class: "xxl" }, [
        a("code", null, "--font-size-xxl"),
        n("Larger font size"),
      ]),
      a("li", { class: "xl" }, [
        a("code", null, "--font-size-xl"),
        n("Slightly large text size"),
      ]),
      a("li", null, "Default font size"),
      a("li", { class: "xs" }, [
        a("code", null, "--font-size-xs"),
        n("Slightly small text size"),
      ]),
      a("li", { class: "xxs" }, [
        a("code", null, "--font-size-xxx"),
        n("Smaller text size"),
      ]),
    ],
    -1
...
const co = io(function (t, n) {
  return (
    o(),
    e(v, { to: "#portal\\:modal" }, [
      a("div", so, [lo, a("div", ro, [f(t.$slots, "default")])]),
    ])
  );
});
  ...
  return (
    ...
    e("div", fo, [
      t.header
        ? (o(),
          e("header", vo, [
            a("span", { onClick: n[1] || (n[1] = (o) => t.$emit("cancel")) }, [
              po,
              a("span", null, i(t.header), 1),
            ]),
          ]))
        : p("", !0),
      a("main", null, [
        t.icon
          ? (o(),
            e("i", { key: 0, class: ["big", t.icon], color: "a" }, null, 2))
          : p("", !0),
          ...
          ? (o(),
            e(
              "button",
              {
                ...
                style: `\n            color: var(--color-${
                  t.buttonLeft.color || "x-6"
                });\n            flex: ${t.buttonLeft.flex || 1};}\n        `,
              },
          ...
          ? (o(),
            e(
              "button",
              {
                ...
                style: `\n          color: var(--color-${
                  t.buttonRight.color || "x-6"
                });\n          flex: ${t.buttonRight.flex || 1};}\n        `,
              },
              ...
              default: yo(() => [
                a(
                  c,
                  {
                    ...
                    onButtonLeftClick:
                      l[3] || (l[3] = (t) => (s.showModal = !1)),
                    onButtonRightClick:
                      l[4] || (l[4] = (t) => (s.showModal = !1)),
                    icon: "icon-trash-bin-small",
                    header: s.t("modal.header"),
                    title: s.t("modal.title"),
                    text: s.t("modal.text"),
  ...
  t.i18n = {
    en: {
      ...
      modal: {
        ...
        text:
          "Deleting this post will remove it from all the pages and widgets. This action can not be undone.",
        buttonLeft: "Cancel",
        buttonRight: "Delete",
      },
    },
    ...
    e("div", Co, [
      a(
        r,
        {
          ...
          reverse: !0,
          onClick:
            l[1] || (l[1] = (t) => s.notify({ message: s.t("message") })),
        },
      ...
      a(
        r,
        {
          ...
          onClick:
            l[2] ||
            (l[2] = (t) =>
              s.notify({ message: s.t("message"), status: "warning" })),
        },
      ...
      a(
        r,
        {
          ...
          onClick:
            l[3] ||
            (l[3] = (t) =>
              s.notify({ message: s.t("message"), status: "error" })),
        },
      ...
      a(
        r,
        {
          ...
          onClick:
            l[4] ||
            (l[4] = (t) =>
              s.notify({ message: s.t("message"), status: "success" })),
        },
...
const Eo = To(function (n, s) {
  ...
  return (
    o(), e("section", Ro, [a("h1", null, i(n.t("heading")), 1), Mo, a(l), a(r)])
  );
});
var Ho = (t) => {
  t.i18n = {
...
const No = qo(function (n, s) {
  ...
  return (
    ...
    e("section", Go, [
      a("h1", null, i(n.t("title")), 1),
      Fo,
      a(l, { schema: n.schema, locale: n.messages }, null, 8, [
        "schema",
        "locale",
      ]),
    ])

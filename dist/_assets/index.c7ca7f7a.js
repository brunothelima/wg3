...
t(g, (e) => {
  localStorage.setItem("wg3.locale", e),
          ...
          e.selected
            ...
            : (o(),
              d(
                "div",
                j,
                p((e.t && e.t(e.placeholder)) || "Select an option"),
                1
              )),
          O,
        ]),
    ...
    d(
      ...
      },
      {
        default: J(() => [
          e.icon
            ? (o(),
              d("i", { key: 0, "data-test": "icon", class: e.icon }, null, 2))
            : y("", !0),
...
const Q = (e) => {
  for (let t of Object.values(e))
    "value" in t || (t.value = ""), "errors" in t || (t.errors = []);
  return e;
};
      ...
      [
        e.input.label
          ? (o(),
            d(
              "label",
              { key: 0, class: "field__label", for: e.id },
              p(e.t(e.input.label)),
              9,
              ["for"]
            ))
  ...
  setup(e, t) {
      ...
      { schema: s, data: n, validate: o } = ((e) => {
        ...
        return {
          ...
          validate: async () => {
            ...
            return !Object.values(t).some(({ errors: e }) =>
    ...
    return {
      ...
      onInputHandler: (e) => {
        ...
        (l.value = a),
          (l.errors = []),
          l.events && l.events.onInput && l.events.onInput(e, s);
      },
